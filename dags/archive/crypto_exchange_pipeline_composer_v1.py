...
dag = DAG(
    dag_id = 'crypto_exchange_pipeline_composer_v1',
    default_args= default_args,
    description= "Fetch data from coingecko api (Composer version)",
...
#create big query table using BigQueryInsertJobOperator (compatible with Composer)
